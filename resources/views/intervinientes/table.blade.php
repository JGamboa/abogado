...
<div class="row">
    <div class="col-sm-5">
        <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Mostrando {{ $intervinientes->firstItem() }} a {{ $intervinientes->lastItem() }} de {{ $intervinientes->total() }} registros</div>
    </div>
    <div class="col-sm-7">
